...
\item[Intercession and Structural reflection] attributes (method or variable) of an object can be added or replaced.
\item[behavioural reflection] dispatching mechanism can be changed.
\end{description}
