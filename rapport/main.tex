...
JavaScript has a weaker API for reflection and meta-programming than Python. But this might change with ECMAScript 6 that will bring new built-in objects (Proxy and Reflect).

\section{Conclusion}

* Possibilités de la reflexion

* Mechanisme de réflexion différent
