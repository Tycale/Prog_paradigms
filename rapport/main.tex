...
\usepackage[top=3.5cm,bottom=3.5cm,left=4cm,right=4cm]{geometry}
...
Object in Python can be “callable” or not. A callable object is an object having a method named \lstinline|__call__()|. In fact, \lstinline|X(arg1, arg2, ...)| is a shorthand for \mbox{\lstinline|X.__call__(arg1, arg2, ...)|.} To know if an object is callable, we will use the method \lstinline|__getattr__('__call__')| \cite{ python:callable}.
...
JavaScript proceeds method lookup in the following order \cite{js:prototypeChain} :
\begin{enumerate}
