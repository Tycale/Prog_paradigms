...
\hspace{2cm} \textsc{Gerondal} & Thibault & 1093-09-00 \\
\hspace{2cm} \textsc{Heraly } & Michaël & 1772-09-00 \\
\multicolumn{3}{c}{\{thibault.gerondal, michael.heraly\}@student.uclouvain.be} \\
...
%    \centering
    ...
    \end{center}
%    \caption{JavaScript MOP}
%    \label{fig:jsmop}
%\end{figure}

%On figure \ref{fig:jsmop}, when the \lstinline|f1| object is created (with the \lstinline|new| keyword), its \textit{internal} \lstinline|__proto__| refers to the prototype of the \lstinline|Foo| function.
