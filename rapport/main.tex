...
\setpy
Python rely on classes, by calling \lstinline|dir(objectToAnalyse)|, all attributes that the object inherits are retrieved by using the keys in the \lstinline|__dict__| attribute of the object.
